...
uint16_t _TRACE_IGB_IRQ_ICR_WRITE_DSTATE;
...
TraceEvent _TRACE_IGB_IRQ_ICR_WRITE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "igb_irq_icr_write",
    .sstate = TRACE_IGB_IRQ_ICR_WRITE_ENABLED,
    .dstate = &_TRACE_IGB_IRQ_ICR_WRITE_DSTATE 
};
...
TraceEvent *hw_net_trace_events[] = {
    ...
    &_TRACE_IGB_IRQ_ICR_WRITE_EVENT,
